...
function initializeApp() {
    ...
    // Force login screen - no shortcut
    AuthSystem.logout(); // Clear any previous sessions
    showScreen('loginScreen');
    
    // Block direct access to the dashboard
...
// Feature removed - login only with credentials
...
function generateStudentsView() {
    if (!AppState.data || !AppState.data.students) {
        return '<div style="text-align: center; padding: 50px;">Error: Datos no disponibles</div>';
    }
...
function viewStudent(id) {
    ...
    showModal(`
        ...
        <br>
        <p><em>Esta es una vista previa. La versión completa incluye más detalles y funcionalidades.</em></p>
    `);
}
...
function addStudent() {
    showModal(`
        ...
        <p>Esta funcionalidad estará disponible en la versión completa de LearnEx.</p>
        <p>Incluirá formularios completos para:</p>
        <ul>
            <li>Datos personales</li>
            <li>Información académica</li>
            <li>Contacto de emergencia</li>
            <li>Asignación de grado</li>
        </ul>
    `);
}
...
function addGrade() {
    showModal(`
        ...
        <p>Permitirá registrar calificaciones con:</p>
        <ul>
            <li>Selección de materia</li>
            <li>Tipo de evaluación</li>
            <li>Peso de la calificación</li>
...
function addTask() {
    showModal(`
        <h2>Nueva Tarea</h2>
        <p>Esta funcionalidad estará disponible en la versión completa.</p>
        <p>Incluirá:</p>
        <ul>
            <li>Editor de contenido rico</li>
            <li>Adjuntar archivos</li>
            <li>Configurar fechas límite</li>
            <li>Asignar a grupos específicos</li>
        </ul>
    `);
}
...
function addUser() {
    showModal(`
        ...
        <p>Permitirá crear usuarios con diferentes roles y permisos.</p>
    `);
}
...
function markAttendance() {
    showModal(`
        ...
        <p>Sistema de asistencia disponible en la versión completa.</p>
        <p>Incluirá:</p>
        <ul>
            <li>Códigos QR para registro rápido</li>
            <li>Geolocalización</li>
            <li>Reportes automáticos</li>
            <li>Notificaciones a padres</li>
        </ul>
    `);
}
